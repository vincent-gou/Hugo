...
image::Automatisation_Build_Hugo_site_avec_GitHUb_Actions.fr-f4820.png[]

* Sélectionner "Zone DNS"

image::Automatisation_Build_Hugo_site_avec_GitHUb_Actions.fr-f7562.png[]

* Puis sélectionnez ajoutez une entrée, sélectionnez "CNAME"

image::Automatisation_Build_Hugo_site_avec_GitHUb_Actions.fr-414c6.png[]
...
NOTE: il faudra peut-etre ajoueter un "." au domaine de ridrection, par exemple: username.github.io.

image::Automatisation_Build_Hugo_site_avec_GitHUb_Actions.fr-d56e1.png[]
