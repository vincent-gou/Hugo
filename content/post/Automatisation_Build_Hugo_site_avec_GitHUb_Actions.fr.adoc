...
Le resultat du build Hiugo sera déployé dans le repository dédié à GitHub Pages.

Example de structure du dossier dédié aux sources Hugo:
...
Example de structure du dossier:

WARNING: Le contenu de ce dossier est purgé à chaque déploiement.

[source,bash]
----
[root@sd-113165:vincent-gou.github.io] # tree -L 1
.
|-- 404.html
|-- authors
|-- bin
